      ...
      <div class="container">
        <nav>
          ...
          <a href="/kondo/overview" aria-label="logo">
            <span id="logo"><img class="u-header__promo-icon" style="margin-right: 0;" src="/assets/img/kondo.png" alt="SVG">Kondo.io</span>
          </a>
          <!-- End Logo -->
          ...
          <div class="navbar-collapse">
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <!-- Org Selector -->
              <li v-if="$auth.isAuthenticated" class="nav-item u-header__nav-item"
                ...
                <a class="nav-link u-header__nav-link u-header__nav-link-toggle" href="javascript:;"
                   aria-haspopup="true" aria-expanded="false">Change Org</a>

                <!-- Tools   - Submenu -->
                <div v-if="toolsHover" class="hs-mega-menu u-header__sub-menu"
                     style="min-width: 330px;">
                  <div class="u-header__promo-item" v-for="org in installedOrgs">
                    <a class="u-header__promo-link" :href="'/kondo/overview?org=' + org.id">
                      <div class="media align-items-center">
                        <img class="js-svg-injector u-header__promo-icon" :src="org.avatar_url" alt="SVG">
                  ...
                  <div class="u-header__promo-item">
                    <a class="u-header__promo-link" href="/kondo/configure">
                      <div class="media align-items-center">
                        <img class="js-svg-injector u-header__promo-icon" src="/assets/img/gear.png" alt="SVG">
                        <div class="media-body">
                          <span class="u-header__promo-title">
                            Add / Remove Orgs
                          </span>
              ...
              <!-- End Docs -->
              <button v-if="this.$auth.isAuthenticated" type="submit" @click="logout" class="btn btn-primary btn-wide transition-3d-hover ml-3" value="logout"
