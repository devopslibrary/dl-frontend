        ...
        <div class="col-md-7 col-lg-8 mb-7 mb-md-0">
          ...
          <article class="card shadow mb-5" v-for="edge in $page.paginatedLessons.edges" :key="edge.node.id">
            <a v-bind:href="'/' + edge.node.permalink">
              <img class="card-img-top" v-bind:src="'/assets/img/coverart/' + edge.node.coverart"
                   alt="Image Description">
            </a>
            <div class="card-body p-5">
              <a class="d-inline-block text-secondary font-weight-medium text-uppercase small mb-2" href="#">{{
                edge.node.category }}</a>
          ...
          <nav aria-label="Page navigation">
            ...
            <ul class="pagination mb-0">
              ...
              <li class="pager page-item active">
                <Pager :info="$page.paginatedLessons.pageInfo"/>
              </li>
