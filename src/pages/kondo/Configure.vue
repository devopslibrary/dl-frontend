    ...
    <div class="border-bottom w-md-75 w-lg-60 space-2 mx-md-auto">
      <div v-if="!$auth.loading">
        ...
        <div v-if="$auth.isAuthenticated">
          ...
          <p>
            First, please select an organization to configure with Kondo. Note, if you don't see your organization, you
            will need to login to Github and grant access to see it.
          </p>
          <div class="Box">
            <div v-for="org in orgs" class="Box-row">
              ...
              <a
                v-if="!org.installed"
                class="tooltipped float-right tooltipped-multiline tooltipped-n btn btn-primary"
              ...
              <div v-if="org.installed" class="float-right BtnGroup">
                <span
                  class="tooltipped tooltipped-multiline tooltipped-n btn btn-outline BtnGroup-item disabled"
